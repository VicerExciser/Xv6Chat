...
// e1000.c
// int             e1000_transmit(const char *buf, uint len);
// int             e1000_receive(char *buf, uint len);
// int             e1000_transmit(void *buf, uint len);
// int             e1000_receive(void *buf, uint len);
...
extern int      ismp;
void            mpinit(void);
// int mpbcpu(void);	// xv6Chat
// void mpstartthem(void);	// xv6Chat
...
void            wakeup(void*);
void            yield(void);
int             msleep_spin(void*, struct spinlock*, int);	// xv6Chat
void            wakeup_one(void*);	// xv6Chat
// struct proc* allocproc(void);
// char* allockproc(kproc_t thr, char *name);
int 			pkill(char*);
...
pde_t*		setupuserkvm(void);	// xv6Chat
